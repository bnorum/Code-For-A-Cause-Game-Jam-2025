...
public static class PersistentData
{
    ...
    public static List<PersonSchema> peopleWhoShouldBeDamnedToday = new List<PersonSchema>();
    public static List<PersonSchema> peopleWhoShouldBeSavedToday = new List<PersonSchema>();
